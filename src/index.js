...
function addOperator(names: [string] | string, operator : (...args : any) => Node.Class) {
  function func(...args) {
...
addOperator("throttle", (ms : number) => {
...
addOperator("errors", (errHandler : (signal : Signal, rethrow : (signal : Signal) => void) => void) => {
